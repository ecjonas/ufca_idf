...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'dialog\dialog_isozona_brasil.ui'))


class dialogIsozonaBrasil(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(dialogIsozonaBrasil, self).__init__(parent)
        self.setupUi(self)
