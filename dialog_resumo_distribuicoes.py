...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'dialog\dialog_resumo_distribuicoes.ui'))


class dialogResumoDistribuicoes(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(dialogResumoDistribuicoes, self).__init__(parent)
        self.setupUi(self)
