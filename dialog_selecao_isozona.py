...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'dialog\dialog_selecao_isozona.ui'))


class dialogSelecaoIsozona(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(dialogSelecaoIsozona, self).__init__(parent)
        self.setupUi(self)
