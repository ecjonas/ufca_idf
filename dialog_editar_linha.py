...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'dialog\dialog_editar_linha.ui'))


class dialogEditarLinha(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(dialogEditarLinha, self).__init__(parent)
        self.setupUi(self)
