...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'dialog\dialog_entrada_manual.ui'))


class dialogEntradaManual(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(dialogEntradaManual, self).__init__(parent)
        self.setupUi(self)
